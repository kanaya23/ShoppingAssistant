...
> **Note**: If using **Web Gemini API mode** (no API key needed), you can leave `GEMINI_API_KEY` empty. The worker extension will handle Gemini calls instead.
...
============================================================
  ...
  SSL:       True
============================================================
[Server] SSL enabled with self-signed certificate
```
...
### Access:
- [ ] Open `https://mullion.indonesiacentral.cloudapp.azure.com:5000`
- [ ] Accept SSL warning
